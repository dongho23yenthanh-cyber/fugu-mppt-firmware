...
bool LCD::init(uint8_t configuredAddr) {
    if (lcd)
        return false;
...
class LCD_Menu {
    ...
    void padding100(int padVar) {
        if (padVar < 10) { lcd.print("  "); } else if (padVar < 100) { lcd.print(" "); }
    }
    ...
    void displayConfig4() {
        ...
        lcd.print("FAN");
        lcd.setCursor(12, 1);
        if (input.fanStatus == 1) { lcd.print("ON "); } else { lcd.print("OFF"); }
    }
    ...
    void update() {
        ...
        if (settingMode == 1) {
            ...
            if (subMenuPage > subMenuPages) { subMenuPage = 0; } else if (subMenuPage < 0) {
            ...
            if (subMenuPage == 0) {
                ...
                if (MPPT_Mode == 1) { lcd.print("MPPT + CC-CV  "); } else { lcd.print("CC-CV ONLY    "); }

                //SET MENU - BOOLTYPE
                if (setMenuPage == 0) { boolTemp = MPPT_Mode; } else {
            ...
            ///// SETTINGS MENU ITEM: CHARER/PSU MODE /////
                ...
                if (output_Mode == 1) { lcd.print("CHARGER MODE  "); } else { lcd.print("PSU MODE      "); }

                //SET MENU - BOOLTYPE
                if (setMenuPage == 0) { boolTemp = output_Mode; } else {
                    if (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        while (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: MAX BATTERY V /////
                ...
                //SET MENU - FLOATTYPE
                if (setMenuPage == 0) { floatTemp = params.Vout_max; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: MIN BATTERY V /////
                ...
                //SET MENU - FLOATTYPE
                if (setMenuPage == 0) { floatTemp = params.Vout_min; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: CHARGING CURRENT /////
                ...
                //SET MENU - FLOATTYPE
                if (setMenuPage == 0) { floatTemp = params.Iout_max; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: COOLING FAN /////
                ...
                if (enableFan == 1) { lcd.print("ENABLED       "); } else { lcd.print("DISABLE         "); }

                //SET MENU - BOOLTYPE
                if (setMenuPage == 0) { boolTemp = enableFan; } else {
                    if (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        while (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: FAN TRIG TEMP /////
                ...
                //SET MENU - INTTYPE
                if (setMenuPage == 0) { intTemp = temperatureFan; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: SHUTDOWN TEMP /////
                ...
                //SET MENU - INTTYPE
                if (setMenuPage == 0) { intTemp = temperatureMax; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: WIFI FEATURE /////
                ...
                //SET MENU - BOOLTYPE
                if (setMenuPage == 0) { boolTemp = enableWiFi; } else {
                    if (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        while (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: AUTOLOAD /////
                ...
                //SET MENU - BOOLTYPE
                if (setMenuPage == 0) { boolTemp = flashMemLoad; } else {
                    if (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        while (digitalRead(buttonRight) == 1 || digitalRead(buttonLeft) == 1) {
                        }
            ...
            ///// SETTINGS MENU ITEM: BACKLIGHT SLEEP /////
                ...
                lcd.setCursor(2, 1);
                if (blSleepMode == 1) { lcd.print("10 SECONDS    "); } else if (
                    blSleepMode == 2) { lcd.print("5 MINUTES     "); } else if (
                    blSleepMode == 3) { lcd.print("1 HOUR        "); } else if (
                    blSleepMode == 4) { lcd.print("6 HOURS       "); } else if (
                    blSleepMode == 5) { lcd.print("12 HOURS      "); } else if (
                    blSleepMode == 6) { lcd.print("1 DAY         "); } else if (
                    blSleepMode == 7) { lcd.print("3 DAYS        "); } else if (blSleepMode == 8) {
                    lcd.print("1 WEEK        ");
                } else if (blSleepMode == 9) { lcd.print("1 MONTH       "); } else { lcd.print("NEVER         "); }

                //SET MENU - INTMODETYPE
                if (setMenuPage == 0) { intTemp = blSleepMode; } else {
                    if (digitalRead(buttonBack) == 1) {
                        while (digitalRead(buttonBack) == 1) {
                        }
                        blSleepMode = intTemp;
                    ...
                    if (digitalRead(buttonRight) ==
                        ...
                        if (blSleepMode == 1) { lcd.print("10 SECONDS    "); } else if (
                            ...
                            blSleepMode == 7) { lcd.print("3 DAYS        "); } else if (blSleepMode == 8) {
                            lcd.print("1 WEEK        ");
                        } else if (blSleepMode == 9) { lcd.print("1 MONTH       "); } else {
                            lcd.print("NEVER         ");
                        }
                        while (digitalRead(buttonRight) == 1) {
                        }
        ...
        //MAIN MENU
            ...
            if (currentLCDMillis - prevLCDMillis >= millisLCDInterval &&
                enableLCD == 1) {
                //Run routine every millisLCDInterval (ms)
                ...
                if (menuPage > menuPages) { menuPage = 0; } else if (menuPage < 0) { menuPage = menuPages; }

                if (menuPage == 0) { displayConfig1(); } else if (menuPage == 1) { displayConfig2(); } else if (
                    menuPage == 2) { displayConfig3(); } else if (menuPage == 3) { displayConfig4(); } else if (
                    menuPage == 4) { displayConfig5(); }
            }
        }
    }
};
