...
#   ./flash-diff.sh -p "$ESPPORT" build/fugu-firmware.bin
#   ./flash-diff.sh -p "$ESPPORT" 0x10000 build/fugu-firmware.bin
#   ./flash-diff.sh -p "$ESPPORT" write_flash 0x10000 build/fugu-firmware.bin
#
